...
class MainMenu:
    def __init__(self):
        ...
        self.start_game_button = pygame.Rect(WIDTH / 2 - 100, HEIGHT / 2 - 50,
                                             200, 50)
        self.quit_button = pygame.Rect(WIDTH / 2 - 100, HEIGHT / 2 + 50, 200,
                                       50)
    ...
    def draw(self, screen):
        ...
        title_text = self.font_title.render("Главное меню", True,
                                            (255, 255, 255))
